...
import { ProductOrdersComponent } from './product-management/lists/product-orders.component';
...
const routes: Routes = [
  ...
  { path: 'orders/:categoryId/:productId/:orderCount', component: ProductOrdersComponent }
];
